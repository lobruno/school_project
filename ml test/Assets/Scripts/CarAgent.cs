...
public class CarAgent : Agent
{
    ...
    {                                           
        public float reward_forward = 0.001f; 
        public float reward_barrier = -0.8f; 
        public float reward_car = -0.5f; 
    }
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        switch (actions.DiscreteActions.Array[0])   //move
        {
            ...
            case 2:
                ...
                AddReward(mag * rwd.reward_forward);
                break;
        }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            AddReward(mag * rwd.reward_barrier);
            if (doEpisodes == true)
                EndEpisode();
        }
        else if (collision.gameObject.CompareTag("Car") == true)
        {
            AddReward(mag * rwd.reward_car);
            if (doEpisodes == true)
                EndEpisode();
        }
    }
